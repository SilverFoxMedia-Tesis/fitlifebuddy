...
class PlanApi {
  ...
  // Create Plan
  Future<Plan> createPlan(String patientId, String frequency, String goalType) async {
    final response = await _apiBase.post('plans/$patientId', body: json.encode({"frecuently": frequency, "goalType": goalType}));
